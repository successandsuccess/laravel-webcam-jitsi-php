        ...
        <section class="header-section mb-20">
            <div class="margin-l-50 margin-r-50 mt-10">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h1 class="color-b text-center special-font">Individualized Care Plan</h1>
                    </div>
        ...
        <section class="news-grid grid d-flex" style="height: 80vh;">
            <div class="pt-20 m-auto w-100">
                <div class="row w-100 ">
                    ...
                    <div class="col-md-6">
                        <div class="text-center" style="background-image: url('assets/img/shutterstock_725473423.jpg'); height: 100%; background-size: cover;">

                        </div>
                    </div>

                    <div class="col-md-6 padding-r-60 mobile-response-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right-mobile">
                                <a href="{{ route('demonstrate') }}"><button class="btn btn-primary  h-55 background-green width-80"><b class="font-s-18">Next Step ></b></button></a>
                            </div>
                        </div>
