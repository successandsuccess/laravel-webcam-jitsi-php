        ...
        <section class="header-section mb-20">
            <div class="margin-l-50 margin-r-50 mt-10">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h1 class="color-b text-center special-font">Demonstration of Exercises</h1>
                    </div>
        ...
        <section class="news-grid grid d-flex" style="height: 80vh;">
            <div class="pt-20 m-auto w-100 mobile-response-center">
                <div class="row w-100">
                    ...
                    <div class="col-md-10 padding-r-60">
                        ...
                        <div class="row mb-50">
                            ...
                            <div class="col-md-3">
                                <!-- <iframe width="100%" src="https://www.youtube.com/watch?v=vuGnzLxRvZM&feature=youtu.be" style="border: none;">
                                </iframe> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 text-right-mobile">
