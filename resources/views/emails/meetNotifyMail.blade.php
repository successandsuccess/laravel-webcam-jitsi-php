...
<body>
    <div class="container">
        ...
        <h2 class="mail-h2">When you are available, please join patient video session by <a class="mail-red" style="color:red;" href="<?php echo $details['meetUrl']; ?>">clicking Here.</a></h2>
        <h2>Thank you.</h2>
    </div>
